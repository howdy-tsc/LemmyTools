...
function Toggle(overide) {
  ...
  var b = document.getElementById("toggle");
	...
	var sh = document.getElementById("ltBarSubHeader");
//on remote instance just hide the bar.
    ...
    h.innerHTML = localStorage.getItem('variable_Toggle_oldH');
...
if (expandImageSpeed > 3)
{
expandImageSpeed = 3;
}
if (expandImageSpeed < 0.1)
{
expandImageSpeed = 0.1;
}
...
if (settings.expandImages == "true")
{
    ...
    for (var i = 0; i < alreadySeen.length; i ++) {
          try{
          alreadySeen[i].outerHTML = alreadySeen[i].outerHTML;
          delete alreadySeen[i];
          }catch{}
    		}
   ...
   if(e.which === 1 &&  mouseReference.buttonDown && mouseMove) {
    ...
    var deltaX = mouseX ;
      ...
      deltaY =  ((mouseX + mouseY) / 2 )* settings.expandImageSpeed;
...
"<tr><td><b>Auto Expand Size</b><br />Size of post image after opening a image post.<br /> Desktop Default: 75 / Mobile: 100</td><td><textarea name='option_ExpandImageSize'>" + settings.ExpandImageSize + "</textarea></td></tr>" +
"<tr><td><b>Expand Image Speed</b><br />Speed multiplier for expanding images. If your images seem to expand<br /> to fast or slow, increase or decrease this value. [Values 0.1 to 3.0]<br /> Default: 0.55 </td><td><textarea name='option_expandImageSpeed'>" + settings.expandImageSpeed + "</textarea></td></tr>" +
...
idiv.innerHTML = " <header id='ltBarHeader' class='card-header'><h6 style='font-size: 0.90rem !important;'><a href=" + settings.theInstance + ">Home</a> - <a href='https://lemmyverse.net/communities' target='_new'>Find Comms</a> - <img width=22 height=22 class='targetImg' src='data:image/webp;base64,' />" +
"</h6></header>" +
"<input type='text' id='commsearch' name='commsearchinput' oninput='searchComms(commsearch.value, communityArray, div)' placeholder='Search your subscriptions (or visted subs)' /> " +
"<b id='ltBarSubHeader' class='clickAble'>LemmyTools " + ltVer + " - <a href='#' id='LToptions' onclick='options(" + 1 + ")'>Options</a></b><div style='clear:both;'></div>";
var div = document.createElement("div");
div.setAttribute("id", "myDiv");
div.classList.add("ltcommsbar");


var styleString = ".ltmenu {position: fixed; padding:0; margin:0; top: " + settings.positionVertical +"%;" + settings.positionSide + ": 0; font-size: .75em; display: block; height: 100%; min-height: auto;" +
